...
custom_prompt = """ Given a tweet, generate multiple hypotheses for what entity, theme, or subject the tweet expresses an opinion about.
...
# Load your dataset
dataset = load_dataset("csv", data_files="/home/bhavani/Desktop/LLM_Target_Stance/btsd/new_combined_dataset.csv", split="train")
...
training_args = TrainingArguments(
    output_dir="./llama31_finetuned_tot_comibined",
...
print(f"\n✅ Final training loss: {final_loss:.4f}" if final_loss else "⚠️ Final loss not found.")